...
// 获取末地维度
const theEnd: Dimension = world.getDimension("the_end");
...
export const NTF_Rifle = {
  ...
  target_tip:
    "§f支援设施内的安全官员配合他们阻止混沌分裂者的入侵，消灭所有混沌分裂者，尽全力保护设施安全。§6听从指挥官的指挥",
  tag: "ntf",
  group: "ntf",
  state: "Alive",
  tag_spawn: "ntf_spawn",
...
export const NTF_Commander = {
  ...
  target_tip:
    "§6指挥你的队员，§f支援设施内的安全官员配合他们阻止混沌分裂者的入侵，消灭所有混沌分裂者，尽全力保护设施安全",
  tag: "ntf_com",
  group: "ntf",
  state: "Alive",
  tag_spawn: "ntf_spawn",
